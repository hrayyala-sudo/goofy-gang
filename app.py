...
# --- 5. MAIN DASHBOARD HEADER WITH SECRET TAP TRIGGER ---
title_col1, title_col2 = st.columns([1, 12])

with title_col1:
    # Clicking the emoji acts as the easter egg trigger
    if st.button("🤪", key="secret_emoji_trigger", help="Click for a secret!"):
...
if st.session_state["show_secret_game"]:
    st.info("🎉 **SECRET UNLOCKED!** You found the Goofy Easter Egg Game!")
